...
gjs -m gnome-extension/tests/standalone-lifecycle-test.js # offline/reconnect ordering
gjs -m gnome-extension/tests/offline-render-test.js /tmp # offline text bounds + PNGs
